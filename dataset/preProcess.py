...
def get_protein(cancer_type, target='OS', groups=("WHITE", "NAT_A")):
...
def get_mRNA(cancer_type, target='OS', groups=("WHITE", "BLACK", "ASIAN", "NAT_A", "OTHER")):
...
def get_dataset(cancer_type, feature_type='Integ', target='OS', groups=("WHITE", "BLACK", "ASIAN", "NAT_A", "OTHER")):
...
def get_dataset_integ(cancer_type, feature_type=['Protein'], target='OS', groups=("WHITE", "BLACK", "ASIAN", "NAT_A", "OTHER")):
    datasets = []
...
def get_race(cancer_type):
    ...
    # df1.to_excel(writer, sheet_name='df_list', index=False)
    # writer.save()
...
# def main():
#     # get_race('PanPan')
#     # get_protein('OV', 'DSS', ['NAT_A', 'ASIAN'])
#     dataset2 = get_dataset('KIPAN', 'mRNA', 'DSS', groups=["WHITE", "ASIAN"])
#     dataset2 = standarize_dataset(dataset2)
#     dataset2 = get_one_race(dataset2, 'ASIAN')
#     print(get_n_years(dataset2, 3))
